...
from dizher.gui.state import DizherState
...
def test_converter_changes_restart_from_the_latest_parent_state():
    ...
    gui.handle_converter_param('chroma_noise', .3)
    ...
    gui.handle_converter_param('chroma_noise', .4)
    ...
    gui.handle_converter_param('luma_scale', .7)
    gui.handle_halftone('halftone-stohastic')
    gui.handle_converter_param('structure', .2)
