...
class DBS(Ditherer):
    ...
    def __call__(self, luma, paper, ink, scale=1.0, alpha=0.95, **eye):
        return dbs_duo(luma, paper, ink, init=noise_dither(duo_levels(luma, paper, ink)), scale=scale, alpha=alpha)
